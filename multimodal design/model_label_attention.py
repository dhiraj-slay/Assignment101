...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, num_classes=4, block_name='BasicBlock'):
        ...
        self.first_linear = nn.Linear(64 * block.expansion, 64 * block.expansion, bias=False)
        self.second_linear = nn.Linear(64 * block.expansion, num_classes, bias=False)
        self.third_linear = nn.Linear(64 * block.expansion, num_classes)
    ...
    def forward(self, x, init_states=None):
        ...
        # x = self.fc(x)
        # x = self.fc_final(x)
        weights = torch.tanh(self.first_linear(e))
